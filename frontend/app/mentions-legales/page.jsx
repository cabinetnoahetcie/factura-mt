...
Les données sont hébergées sur des serveurs certifiés avec chiffrement en transit (HTTPS/TLS).`,
          },
          {
            ...
            contenu: `Conformément à la loi camerounaise n°2010/012 relative à la cybersécurité et à la cybercriminalité, le Cabinet Global Enerdy s'engage à :
...
• Supprimer définitivement vos factures 48 heures après la livraison de votre rapport.
• Garantir la confidentialité de vos informations commerciales.
...
• Ces données sont utilisées exclusivement pour produire votre rapport d'analyse énergétique.`,
          },
          {
            ...
            contenu: `Toutes les communications entre votre navigateur et notre plateforme sont chiffrées via le protocole HTTPS (TLS 1.3). Vos factures sont stockées dans un espace cloud à accès restreint, accessible uniquement par les ingénieurs du Cabinet Global Enerdy affectés à votre dossier.`,
          },
          {
            titre: '6. Confidentialité professionnelle',
            contenu: `Le Cabinet Global Enerdy est soumis au secret professionnel. Les informations contenues dans vos factures ENEO sont considérées comme des informations stratégiques confidentielles et traitées comme telles par l'ensemble de notre équipe.`,
          },
          {
